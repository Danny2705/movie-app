...
export default function ProfilePage() {
  ...
  return (
    <div className={`${darkMode ? "dark-mode" : "light-mode"} home px-[100px]`}>
      <img
        src='/assets/aot.jpg'
        alt='Background Img'
      ...
      <div className='w-full min-h-[100vh] py-20 flex justify-center items-center'>
        ...
        <div
          className={`flex justify-center items-center relative z-10 w-full bg-opacity-80 ${
          ...
          <div className='flex flex-col gap-4 py-4 w-[500px]'>
            ...
            <div className='relative'>
              ...
              <button
                ...
                className={`text-xl bg-main-red w-fit rounded-full p-2 absolute bottom-0 right-0 ${
                  darkMode ? "hover:bg-black" : "hover:bg-white"
                } hover:text-main-red duration-200`}
              >
                <LuUpload />
              </button>
            </div>
                ...
                <div className='flex flex-col items-center justify-start w-full gap-4'>
                  <input
                    ...
                    className={`outline-none py-2 px-2 ${
                      darkMode ? "bg-[#070A16]" : "bg-[#ccc]"
                    } border border-[#262938] w-[270px]`}
